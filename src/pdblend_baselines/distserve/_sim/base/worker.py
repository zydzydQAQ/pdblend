# Copyright 2024 DistServe Authors. Apache-2.0.
# Modified 2026-09-14: import namespace only; engine-independent measured latency provider.
# Upstream 82831f1604cc6b10bebd360f6c437a07790dde9f; LICENSE shipped alongside.
"""
...
from pdblend_baselines.distserve._sim.estimators.time_estimator import get_prefill_time, get_decode_time

if TYPE_CHECKING:
    from pdblend_baselines.distserve._sim.base.scheduler import Scheduler
    from pdblend_baselines.distserve._sim.base.request import Request
