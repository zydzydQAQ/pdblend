...
from ..engine.carry import (CarryProtocolError, SSEEvents, combined_usage, decode_body, diagnostic_body,
                           encode_event, extract_first, first_event, token_ids, validate_request)
                ...
                for event in parser.feed(chunk):
                    ...
                    for choice in event.get("choices", ()):
                        ...
                        if diagnostics:
                            ...
                            record.tokens_so_far = 1 + observed_ids
