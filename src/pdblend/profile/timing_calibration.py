...
from .calibration import digest, evaluate_holdout
from .decode_fit import predict as base_predict
from .model import PerfModel
from .power_calibration import FREQUENCIES, point_key, timing_component, write_immutable
from .wave import atomic_json
from .window_sampling import _background, _running, summarize_window
...
def source_hashes():
    ...
    return {name: digest(here/name) for name in ('timing_calibration.py', 'decode_fit.py', 'window_sampling.py')}
