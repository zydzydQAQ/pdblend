...
try:
 # Prior recorded retirement and cold start are complete; no repeat hardware setup.
 # Existing cold-bootstrap evidence is independently re-audited below.
 from inputs import boot_record,fixed,idle
 boot=boot_record(OUT/'cold-bootstrap/status.json');fixedref=fixed(boot,OUT/'fixed-inputs-v2')
