...
START_CUTOFF = 1788861600.0  # 2026-09-08 18:00 Asia/Shanghai
DELIVERY_CUTOFF = 1788868800.0  # 20:00; the older campaign's 21:06 is not adopted.
...
async def fresh_binding(common, session, parent, out):
    ...
    b.update(deadline_s=DELIVERY_CUTOFF, output=str(out / 'results'),
             ...
             experiment_scope='core ablation, fresh reference arms, same seed701 twice',
