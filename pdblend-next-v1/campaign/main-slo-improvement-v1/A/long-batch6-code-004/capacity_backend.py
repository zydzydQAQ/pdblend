...
class TransitionMeter:
    ...
    async def finish(self):
        ...
        durable(self.out / 'clocks.json', self.sampler.frequency_samples)
        ...
        result = dict(measurement_valid=not self.sampler.error and not window_error and not memory_error
