...
class Gate:
    def __init__(self):
        ...
        self.state = dict(complete=False, passed=False, phase='preflight', started_s=time.time(),
            scope='6 natural batch16 TP2 short512 observations; no profile publication or KV certification',
...
if __name__=='__main__':
    ...
    check()
    if not args.execute:print(json.dumps(dict(package_valid=True,planned_points=6,gpu_executed=False,scheduled=False,required_kv_tokens=12288)))
    else:
