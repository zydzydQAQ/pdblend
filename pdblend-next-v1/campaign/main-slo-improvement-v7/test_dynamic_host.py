"""Lifecycle checks import the actual frozen dynamic host and use bounded fake hardware."""
import asyncio,sys,time,types,unittest
from pathlib import Path
from types import SimpleNamespace as NS
from unittest.mock import AsyncMock
import ecopadg.serving.runtime as original
import build_dynamic_runtime as builder
module=original
