...
class ModelRunner(GPUModelRunnerBase[ModelInputForGPUWithSamplingMetadata]):
    ...
    def execute_model(
        ...
        **kwargs,
        ...
        if (self.vllm_config.kv_transfer_config is not None and
                self.vllm_config.kv_transfer_config.kv_connector == "PDBlendConnector"):
            get_kv_transfer_group().validate_recomputed(
    ...
    def need_recv_kv(self, model_input, kv_caches) -> bool:
        ...
        if self.vllm_config.kv_transfer_config.kv_connector == "PDBlendConnector":
            from vllm.pdblend_runtime import transfer_phase
            return not is_profile_run and is_prefill_run and transfer_phase(model_input, "d")
    ...
    def need_send_kv(self, model_input, kv_caches) -> bool:
        ...
        if self.vllm_config.kv_transfer_config.kv_connector == "PDBlendConnector":
            from vllm.pdblend_runtime import transfer_phase
            return not is_profile_run and is_prefill_run and transfer_phase(model_input, "p")
