...
def predecessor():
    require(EXECUTION_RELEASE is not None, 'explicit repair-window release required; this candidate is not scheduled')
    return validate_execution_release(EXECUTION_RELEASE, ROOT)
