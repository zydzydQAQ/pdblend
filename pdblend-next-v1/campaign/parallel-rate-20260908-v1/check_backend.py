...
CFG=REPO/'campaign/main-slo-improvement-v6/B/fixed-release-001/configs/alpaca.json'
...
async def main():
 ...
 result=dict(schema=1,host=str(HOST),source_sha256=FILES,cpu_cases=records,hardware_mocked=True,gpu_executed=False,
  real_StateManager_and_ClockOwner=True,actual_B_profile_loaded=True,performance_claim=False,
