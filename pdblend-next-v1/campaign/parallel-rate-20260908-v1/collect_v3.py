...
def collect(out,series):
    ...
    for status_path in stage_paths():
        ...
        match=re.search(r'(?:^|[-/])(p[0-9]+)(?:[-/]|$)',str(directory.relative_to(ROOT)))
...
if __name__=='__main__':
    parser=argparse.ArgumentParser();parser.add_argument('--out',type=Path,required=True);parser.add_argument('--series',choices=('p1','p2','p3'),required=True)
