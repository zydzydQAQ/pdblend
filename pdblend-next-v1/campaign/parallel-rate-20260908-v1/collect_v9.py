...
import report_versions_v3 as report_versions
import inspect_baseline_v2 as inspect_baseline
...
def collect(out,series):
    ...
    code_sources={str(path):sha(path) for path in (Path(__file__),ROOT/'boundary_first_loss.py',ROOT/'inspect_exploration.py',ROOT/'report_versions_v3.py',ROOT/'inspect_baseline_v2.py',ROOT/'source_identity.py',ROOT/'report_scope.py',ROOT/'boundary_first_loss_v2.py',AUDIT/'report.py',AUDIT/'protocol.py',AUDIT/'raw_metrics.py')}
