...
def main():
    ...
    out=ROOT/'reports/historical-existing-fixed-slo-scope-001'
    ...
    print(json.dumps(dict(out=str(out),existing_main=450,existing_scale=259,unmeasured_scale=11,new_scale_measurements_required=False)))
