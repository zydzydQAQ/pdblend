...
seen={}
while True:
    outputs=[HERE/'screen-p4',HERE/'p4-completion']+[HERE/'boundary-baselines-p4'/s for s in ('mixed','distserve','dynamollm','ecoserve')]+[HERE/p.name.removesuffix('-release') for p in sorted(HERE.glob('explore-p4-*-release'))]
    for out in outputs:
        try:
