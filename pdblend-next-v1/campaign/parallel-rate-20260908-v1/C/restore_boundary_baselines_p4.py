...
PREVIOUS=HERE/'baseline-boundary-restore-p4/previous-binding.json'
RELEASE=HERE/'boundary-p4/declaration.json'
OUT=HERE/'baseline-boundary-restore-p4'
...
def main():
    ...
    if args.prepare:
        ...
        lifecycle=read(HERE/'baseline-until-complete-v1/manifest.json');dependencies.update(lifecycle['files']);dependencies.update(lifecycle['references'])
        dependencies[str(HERE/'baseline-until-complete-v1/manifest.json')]=sha(HERE/'baseline-until-complete-v1/manifest.json')
