...
def container_equivalence(historical, actual, dns):
    ...
    return dict(host_config=dns.hostconfig_equivalence(historical['HostConfig'], actual['HostConfig']),
                mounts=dns.mounts_equivalence(historical['Mounts'], actual['Mounts']))
