...
C=Path(__file__).resolve().parent;OUT=C/'eco-drain37-continuation-001';P=OUT/'performance'
...
def once():
    ...
    return state
def main():
    for name in ['qualified']:copy_dir(OUT/name)
    for name in ['performance-invocation.json']:
