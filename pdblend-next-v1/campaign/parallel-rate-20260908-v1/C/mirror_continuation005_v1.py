"""Read-only remote mirror of terminal C 005 points and their audit chain."""
import json,subprocess,time,hashlib,sys
from pathlib import Path
import operate as op
C=Path(__file__).resolve().parent
QUEUE=C/'boundary-continuation-p4v2-005'
...
H='172.16.50.105'
SNAPS=C/'mirror-continuation005-observations'
def copy_dir(p):
...
def once():
    ...
    copy_dir(QUEUE/'execution/verified-cells')
