...
def contract(args):
    ...
    require(Path(binding['deployment_receipt'])==HERE/'baseline-after-gamma-restore-002/deployment-receipt.json'
        and Path(binding['correctness_evidence'])==HERE/'boundary-baseline-gate-after-gamma-001','old gate/restoration cannot qualify this attempt')
