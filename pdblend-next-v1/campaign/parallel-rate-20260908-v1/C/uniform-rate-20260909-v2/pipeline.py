    ...
    for system in plan['system_order']:
        ...
        for dataset in plan['datasets']:
            while True:
                ...
                await child([sys.executable, '-B', str(p.HERE / 'prepare_request.py'), '--request',
...
def main():
    ...
    state = dict(schema='uniform-v2-five-system-pipeline-status', plan=plan_ref, pid=os.getpid(),
        ...
        complete=False, node_lease_held=False, phase='starting', observations=[], attempts=[], group_decisions={})
