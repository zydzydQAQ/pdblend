...
def validate_scope(binding):
    ...
    require(binding['host_release']=='/root/workspace/pdblend-next-v1/releases/five-system100-C7B-baseline-v1-runtime','C fresh native correctness uses the original shared backend source')
