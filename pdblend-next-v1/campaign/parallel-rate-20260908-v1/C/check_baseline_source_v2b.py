...
root=HERE/'baseline-source-v2-cpu-b';root.mkdir()
...
for system,host in decl['baseline_controller_hosts'].items():
 ...
 for label,value in [('actual',spec),('v1-policy-reference',baseline_spec)]:
  ...
  configs,notes=m.configurations(value,instances,strategy,['alpaca','sharegpt','longbench'],out,root/system/'measurement-fixture-only',frozen)
