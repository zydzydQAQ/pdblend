...
PACKAGE=HERE/'eco-drain37-v1/package-v2.json'
    ...
    with node_lease():
        ...
        async with aiohttp.ClientSession(trust_env=False) as session:
            ...
            for row in cells:
                ...
                independent=load(HERE/'audit_eco_completed_v1.py','c_eco_arrival_audit').audit(output/'checkpoints'/(row['cell_id']+'.json'))
