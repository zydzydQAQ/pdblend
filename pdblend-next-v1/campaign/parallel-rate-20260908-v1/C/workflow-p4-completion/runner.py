...
DECLARATION_SHA = 'e9e1a9c960445a466ee6572664cab4be3fbbd71f392dec631989c865666d7e75'
...
def engineering_gate(summary, bench_path, first):
    ...
    return dict(passed=not failures and summary.get('work_complete') is True
                and summary.get('failed_requests') == 0 and summary.get('request_timeouts') == 0,
                http503=failures, first_point=first, work_complete=summary.get('work_complete'),
                failed_requests=summary.get('failed_requests'),request_timeouts=summary.get('request_timeouts'),
                any_request_failure_stops_successors=True,complete_low_slo_negative_point_retained=True)
