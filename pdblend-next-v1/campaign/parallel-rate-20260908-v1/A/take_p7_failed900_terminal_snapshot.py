...
ROOT=A.parent
OUT=A/'p7-failed900-terminal-001'
...
async def main():
 import aiohttp
 spec=read(A/'p7-qualification900-inputs-001/spec.json')
 base=read(spec['original_binding']['path']);old=A/'p7-qualification900-dynamic-001'
