...
def main():
 ...
 try:
  ...
  f.save(out/'handoff.json',dict(node='Anew20260909',model='14b',system='pdblend',qualification=qref,qualification_validator=f.ref(H/'verify_v2.py'),formal_execution_started=False))
