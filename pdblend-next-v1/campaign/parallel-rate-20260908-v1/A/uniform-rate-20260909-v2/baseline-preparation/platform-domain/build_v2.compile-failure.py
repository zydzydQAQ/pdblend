...
def edits(name,source):
    ...
    if name=='backend.py':
        ...
        once('self.dynamo_topology=DynamoTopologyPlanner(self.profiles,','self.dynamo_topology=DynamoTopologyPlanner(self.profiles,max_frequency=self.max_frequency,')
