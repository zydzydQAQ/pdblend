...
def build(parent,out):
    ...
    changed={};newfiles={}
    names={'backend.py','runtime.py','ecoserve.py','distserve.py','dynamo.py','frequency.py','topology.py','baselines.py'}
...
if __name__=='__main__':
    ...
    for variant in ('baseline','baseline-eco-drain'):
        ...
        refs[variant]=build(parent,HERE/('runtime-'+variant+'-001'))
    save(HERE/'candidate-hosts-001.json',refs)
