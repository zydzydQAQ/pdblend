...
A = HERE.parent
OUT = A / 'final-p8-continuation-002'
PREDECESSOR = A / 'p8-qualification900-dynamic-002'
...
def main():
    ...
    try:
        ...
        update(phase='complete', complete=True, formal_status=ref(A / 'final-p8-002/status.json'))
