...
def validate_release(path):
    ...
    need(release['measurement_adapter'] == q['measurement_adapter'] == base['isolated_power_adapter']
         and release['measurement_hooks'] == q['measurement_hooks'] == base['measurement_hooks'],
         'formal and actual900 measurement adapters must match')
    import sampler_hooks
    sampler_hooks.references(base)
