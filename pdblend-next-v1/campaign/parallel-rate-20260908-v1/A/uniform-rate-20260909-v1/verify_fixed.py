...
def verify(reference):
    ...
    assert qualification['schema'] == 'new-A-fixed14B-qualification-v1'
    ...
    assert actual_cases == expected_cases and len(cases) == len(expected_cases) == 108
    requests_seen = set()
    for case in cases:
    ...
    return dict(passed=True, independently_recomputed=True, node='Anew20260909', model='14b',
                ...
                datasets=['sharegpt', 'longbench'], native_shape_cases=108, native_requests=len(requests_seen),
