...
def prepare(*, declaration, qualification, qualification_validator, node, model, dataset,
            ...
            measurement_executor=None, extra_files=(), stop_paths=(), dynamic_reuse_observations=(), measurement_purpose='normal'):
    ...
    contract_ref = p.ref(p.ROOT / 'common/uniform-rate-20260909-v2/contract.py')
