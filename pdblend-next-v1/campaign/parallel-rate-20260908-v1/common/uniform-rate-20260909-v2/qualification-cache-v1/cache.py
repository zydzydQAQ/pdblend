...
def build_worker(qualification, validator, out, *, workspace=WORKSPACE):
    ...
    value = dict(schema='immutable-independently-recomputed-qualification-cache-v1',
...
def verify_cached(reference, cache_reference):
    ...
    need(value['schema'] == 'immutable-independently-recomputed-qualification-cache-v1'
