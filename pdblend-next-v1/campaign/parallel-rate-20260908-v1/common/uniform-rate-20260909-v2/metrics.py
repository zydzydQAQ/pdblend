...
def diagnosed_zero_output(checkpoint_reference):
    ...
    if reference_adapter:
        auditor = ROOT / 'common/token-evidence-v2/audit_native_queue.py'
        need(sha(auditor) == '2aeabaafd550ba5326383cd193618b31110f27575f67c841a1951f3250cbf6c5', 'native refusal reference adapter changed')
