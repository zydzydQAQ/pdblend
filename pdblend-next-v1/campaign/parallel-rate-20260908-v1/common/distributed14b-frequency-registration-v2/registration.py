...
DRIVERS={str(HERE.parent/'distributed14b-frequency-profile2100-v1/manifest.json'):'16405b86c6bb1b50970a0d831e21013de3b705e21f2fcb1682f5ad18572eb3e4'}
...
def _verify(registration_reference,profile_reference=None):
    ...
    need(declaration['schema']=='distributed14b-actual2100-registration-input-v2' and declaration['approved'] is True,
    ...
    need(declaration['node']==spec['node']=='C' and spec['registration_frequency_mhz']==2100 and declaration['hostname']==spec['hostname']
...
def prepare(measurement_path,out):
    ...
    declaration=dict(schema='distributed14b-actual2100-registration-input-v2',approved=True,node=spec['node'],hostname=spec['hostname'],
