...
def audit(cp_path):
    ...
    assert sha(Path(__file__).with_name('verify_native_raw_v3.py'))=='80ce376771525348453b0cf6d668fe20280cb941c7d20a823b9398971d628a9a'
    raw=load(Path(__file__).with_name('verify_native_raw_v3.py'),'eco_native_raw').verify(cp_path)
    ...
    files[str(C/'audit_eco_completed_v1.py')]=sha(C/'audit_eco_completed_v1.py');files[str(Path(__file__).with_name('verify_native_raw_v3.py'))]=sha(Path(__file__).with_name('verify_native_raw_v3.py'))
