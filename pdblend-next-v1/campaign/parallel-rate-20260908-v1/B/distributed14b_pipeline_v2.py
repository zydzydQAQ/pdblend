...
def main():
    ...
    plan=read(args.plan)
    need(plan['schema']=='B-distributed14b-P11-persistent-handoff-v2' and plan['authorized'] is True and plan['node']=='B' and plan['dataset']=='sharegpt','exact B assignment required')
    ...
    try:
        ...
        need(prior['node']=='B' and prior['classification']=='idle_unprofiled_observation_requeue_without_native_forward' and prior['scientific_comparison_eligible'] is False and prior['valid_capacity_negative'] is False, 'exact preserved P10 engineering failure required')
