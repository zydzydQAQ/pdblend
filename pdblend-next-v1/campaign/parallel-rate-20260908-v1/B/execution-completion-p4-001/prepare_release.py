...
FLAGS = {'admission_round_fairness': True, 'pending_admission_capacity_guard': True,
         'measured_frequency_write_guard_v1': True, 'observed_first_admission_frequency_v1': False, 'observed_idle_admission_frequency_v2': True, 'unconfirmed_retained_admission_deferral_v1': True}
