...
def predecessor():
    ...
    require(prior_status.get('complete') is True and prior_status.get('measurement_valid') is True and prior_status.get('child_exit_confirmed') is True and prior_status.get('cleanup_complete') is True, 'prior profile cleanup incomplete')
