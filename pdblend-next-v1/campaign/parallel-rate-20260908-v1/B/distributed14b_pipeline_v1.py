...
def main():
    ...
    plan=read(args.plan)
    need(plan['schema']=='B-distributed14b-persistent-handoff-v1' and plan['authorized'] is True and plan['node']=='B' and plan['dataset']=='sharegpt','exact B assignment required')
    ...
    try:
        ...
        for name in ('register','prepare_pdb','run_pdb'):invoke(name,plan['commands'][name])
