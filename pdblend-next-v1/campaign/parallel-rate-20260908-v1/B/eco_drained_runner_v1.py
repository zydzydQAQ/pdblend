...
B=Path(__file__).resolve().parent;sys.path.insert(0,str(B));import eco_drained_qualify_v1 as qualification
c=qualification.c;p=c.p;DECL=qualification.DECL;RULES=B/'eco-drain37-v1/execution-rules-v1.json'
