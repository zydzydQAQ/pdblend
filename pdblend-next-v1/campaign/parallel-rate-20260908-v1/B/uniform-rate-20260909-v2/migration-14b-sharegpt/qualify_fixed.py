...
def validate(spec):
    ...
    assert bootstrap['hostname'] == 'iZwz9i5bte3xkpmcoes3t2Z' and not bootstrap['node_lease_held']
...
def make_binding(spec, bootstrap, out, common):
    ...
    return dict(schema=1, protocol_id=common.PROTOCOL, model='14b', system='pdblend',
                ...
                seeds=[701], formal_eligible=False, new_physical_node=False, node='B', old_node_qualifications_inherited=False,
...
def main():
    ...
    state = dict(schema='migration-B-fixed14B-qualification-status-v1', node='B', model='14b',
