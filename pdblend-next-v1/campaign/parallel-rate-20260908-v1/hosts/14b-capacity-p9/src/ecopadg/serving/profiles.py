...
class ProfileStore:
    def __init__(self, points, *, fingerprint="", node_residency_w=0,
                 idle_unallocated_gpu_w=0, gpu_count=8,parked_residency_w_by_tp=None,interference_points=(),mixed_decode_phase_fallback=False):
        self.mixed_decode_phase_fallback = mixed_decode_phase_fallback is True
    ...
    def lookup_execution_phase(self, role, tp, frequency, input_tokens, context, batch):
