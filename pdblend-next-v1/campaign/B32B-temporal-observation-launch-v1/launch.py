...
PACKAGE=CAMPAIGN/'B32B-temporal-observation-execution-v2-r2'
PACKAGE_SHA='cc9f4a708ea761563803af6b6c440a48beb8e03e0081291e2980efad11343b21'
...
ATTEMPT=CAMPAIGN/'B32B-temporal-observation-attempt-001'
...
def frozen():
 m=read(ROOT/'manifest.json');require(sha(ROOT/'launch.py')==m['files']['launch.py'],'launcher source changed')
...
def launch():
 ...
 try:
  while True:
   ...
   time.sleep(5)
  state['phase']='verifying_main90';save();gate=c.main_gate(SEQUENCE/'main-proof.json');state['main_gate']=gate['groups'];save()
